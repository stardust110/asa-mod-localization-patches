...
- 修正 Insaluna 的模组专名处理规则：生物与角色名保持英文原名；地点、组织、日志、祭坛、晶体及关联战利品按明确上下文译为中文。
- 新增永恒隧道、无魂空洞、珊瑚峭壁、跃鳄部落、核能水晶、蔚蓝/金黄/赤红水晶，以及角色关联器官和战利品的中文显示。
- 保持 `3+1` 布局；普通中文和双语 ZIP 均通过 UnrealPak 测试与 ZIP CRC 校验。
